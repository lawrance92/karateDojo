...
<!-- Mirrored from webdesign-finder.com/html/okorner/service-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:39:58 GMT -->
<head>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-12 text-center">
							<h1 class="bold">Single Service</h1>
							<ol class="breadcrumb">
			...
			<section class="ds s-py-90 c-mb-30 c-gutter-30">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-6">
							<img width="575" height="380" src="images/gallery/15.jpg" alt="">

						</div>
						<div class="col-md-6">
							<h5>Kids Karate Groups</h5>

							<p>
								Jerky picanha leberkas, spare ribs meatball chicken doner kevin pork chop shoulder alcatra drumstick chuck andouille. Ground round lion picanha capicola chicken pork frankfurter. Andouille boudin meatloaf porchetta,
								tongue pork belly bresaola pig pastrami doner strip steak. Spare ribs biltong beef ball tip.
							</p>
							<ul class="list-styled">
								<li>Pork chop kevin jerky short ribs </li>
								<li>Pork chop kevin jerky short ribs </li>
								<li>Sirloin filet mignon pork loin jowl </li>
							</ul>
						</div>
					...
					<div class="row">
						...
						<div class="col-12">
							<p>Turducken tail pancetta meatloaf doner ground round, bresaola filet mignon ham brisket sausage tongue prosciutto.
								Pork loin short loin burgdoggen landjaeger capicola pastrami. Burgdoggen jowl porchetta shoulder biltong pork belly prosciutto
								ribeye pastrami ball tip beef kielbasa capicola turkey. Pig jowl landjaeger venison short loin, swine shank picanha meatloaf.
								Rump bacon short ribs chuck, tongue venison swine pork chop.
								Biltong fatback bacon pork loin spare ribs tongue swine beef tail t-bone hamburger.</p>
						</div>
