...
<!-- Mirrored from webdesign-finder.com/html/okorner/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:45:16 GMT -->
<head>
...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="ds s-py-60 s-py-md-90 c-gutter-60">
				<div class="container">
					<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										...
										<div class="form-group has-placeholder">
											...
											<textarea aria-required="true" rows="4" cols="45" name="message" id="message" class="form-control" placeholder="Your Message*"></textarea>
										</div>
									</div>
						...
						<div class="col-lg-12 col-xl-6">
							<div class="ds ms page_map map-small mt-50 mt-xl-0">
								<div class="marker">
			...
			<section class="s-py-60 c-my-15 cs s-parallax s-overlay contact-info">
				<div class="container">
					<div class="row">
