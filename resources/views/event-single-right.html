...
<!-- Mirrored from webdesign-finder.com/html/okorner/event-single-right.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:41:37 GMT -->
<head>
...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-12 text-center">
							<h1 class="bold">Single Event with Right Sidebar</h1>
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">
									Single Event with Right Sidebar
								</li>
							</ol>
						</div>
			...
			<section class="ds s-pt-60 s-pb-0 s-py-md-90 c-gutter-60">
				<div class="container">
					<div class="row">
						...
						<main class="col-lg-7 col-xl-8">
									...
									<header class="entry-header">
										<div class="entry-meta">
											<div class="entry-date">
												<a href="blog-single-video-right.html" rel="bookmark">
							...
							<div id="comments" class="comments-area ds ms">
										...
										<article class="comment-body">
											<footer class="comment-meta">
												<div class="comment-author vcard">
													...
													<h4>Cornelia Graves</h4>
													<p class="small-text text-left color-main">
														dec 26 2017
													</p>
												</div>
												<div class="reply">
													<a rel="nofollow" class="comment-reply-link" href="#" aria-label="Reply to John Doe"><i class="fa fa-reply" aria-hidden="true"></i></a>
												</div>
												<!-- .comment-author -->
												<!-- .comment-metadata -->
											</footer>
											...
											<div class="comment-content">
												<p>Capicola hamburger corned beef andouille pork pork chop buffalo shank ham hock kevin.</p>
											</div>
											<!-- .comment-content -->
										...
										<ol class="children">
											<li class="comment">
												<article class="comment-body">
													...
													<div class="comment-content">
														<p>Tri-tip kevin ball tip frankfurter alcatra rump ground round pork porchetta.</p>
													</div>
													<!-- .comment-content -->
												...
												<ol class="children">
													<li class="comment">
														<article class="comment-body">
															...
															<div class="comment-content">
																<p>Brisket pork chop pork belly filet mignon ribeye pig hamburger.</p>
															</div>
															<!-- .comment-content -->
								...
								<div id="respond" class="comment-respond ds">
									<h5 id="reply-title" class="comment-reply-title">Leave comment:</h5>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group has-placeholder">
													...
													<input type="text" aria-required="true" size="30" value="" name="phone" id="phone" class="form-control" placeholder="Number">
												</div>
											</div>
										</div>
