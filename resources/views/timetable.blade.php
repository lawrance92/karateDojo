...
<!-- Mirrored from webdesign-finder.com/html/okorner/timetable.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:41:43 GMT -->
<head>
...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class=" ds s-py-60 s-py-md-80">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-12">
							<div class="row justify-content-center">
								<div class="col-md-10 col-xl-8">
									<div id="timetable_filter" class="filters gallery-filters small-text text-lg-right">
										<a data-filter="all" href="#" class="selected">All</a>
										<a data-filter=".kids-karate" href="#">kids karate</a>
										<a data-filter=".kick-boxing" href="#">kick boxing</a>
										<a data-filter=".adult-karate" href="#">adult karate</a>
										<a data-filter=".jiu-jitsu" href="#">jiu-jitsu</a>
										<a data-filter=".teen-karate" href="#">teen karate</a>
										<a data-filter=".kung-fu" href="#">kung fu</a>
									</div>
								</div>
							</div>
						</div>
								...
								<table class="table_template darklinks" id="timetable">
									...
									<tbody>
										<tr>
											<th>8:00 - 9:00</th>
											<td>
												<a href="event-single-left.html" class="kids-karate">
													Kids Karate <span>randal schwartz</span>
												</a>
											</td>
											<td>
												<a href="event-single-left.html" class="kick-boxing">
													Kick Boxing <span>Brett Hawkins</span>
												</a>
											</td>
											<td>
												<a href="event-single-left.html" class="adult-karate">
													Adult Karate <span>Ralph Lawson</span>
												</a>
											</td>

											<td>
												<a href="event-single-left.html" class="jiu-jitsu">
													Jiu-Jitsu <span>Erik Warner</span>
												</a>
											</td>
											<td>
												<a href="event-single-left.html" class="teen-karate">
													Teen Karate <span>Mark Lawrence</span>
												</a>
											</td>
											<td>
												<a href="event-single-left.html" class="kung-fu">
													Kung-Fu <span>Garrett Farmer</span>
												</a>
											</td>
											<td>
