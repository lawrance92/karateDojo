...
<!-- Mirrored from webdesign-finder.com/html/okorner/gallery-title.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:43:37 GMT -->
<head>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-12 text-center">
							<h1 class="bold">Gallery: Images with Title</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							...
							<div class="row isotope-wrapper masonry-layout c-mb-30" data-filters=".gallery-filters">
								...
								<div class="col-xl-4 col-md-6 business news innovations">
									<div class="vertical-item text-center ">
										<div class="item-media">
								...
								<div class="col-xl-4 col-md-6 business entertainment corporate">
									<div class="vertical-item text-center ">
										<div class="item-media">
