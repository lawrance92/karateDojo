...
<!-- Mirrored from webdesign-finder.com/html/okorner/comingsoon.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:41:43 GMT -->
<head>
...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="page_topline ds s-borderbottom c-my-10 d-lg-none">
			...
			<section class="ds s-py-60 s-py-md-90 s-overlay s-parallax coming-soon">
				<div class="container">
					<div class="row">
