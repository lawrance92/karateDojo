...
<!-- Mirrored from webdesign-finder.com/html/okorner/team-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:41:43 GMT -->
<head>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-12 text-center">
							<h1 class="bold">Member Profile</h1>
							<ol class="breadcrumb">
						...
						<div class="col-12">
							<div class="row c-gutter-60">
								...
								<div class="col-md-12 col-lg-8">
									<p>
										Pig kevin hamburger pancetta burgdoggen. Biltong salami leberkas kevin picanha chuck pork tenderloin buffalo.
										Boudin buffalo cow, ham turducken jowl porchetta spare ribs filet mignon.
										Chuck leberkas flank, ham hock cow beef venison shoulder pork belly ribeye. Swine porchetta short ribs venison buffalo.
									</p>
									<p>
										Venison meatball chicken biltong cow ham hock rump drumstick flank. Ham hock leberkas ball tip rump cow beef pig, landjaeger pancetta.
										Tri-tip fatback chicken ribeye strip steak sirloin tip drumstick pork loin.
									</p>
									<ul class="list-styled">
										<li>
											<a href="services.html">Strip steak prosciutto frankfurter jowl</a>
										</li>
										<li>
											<a href="services.html">Sirloin pork belly fatback meatball</a>
										</li>
										<li>
											<a href="services.html">Cupim beef hamburger shank ham</a>
										</li>

									</ul>

									<p>
										T-bone jerky cow doner, flank swine tenderloin bacon leberkas meatloaf.
										Burgdoggen hambur salami meatball venison chuck. Pancetta prosciutto porchetta swine chuck rump t-bone ham
										shoulder pork lion.
									</p>
									<!-- tabs start -->
									...
									<div class="tab-content mb-40">
										...
										<div class="tab-pane fade show active" id="tab01_pane" role="tabpanel" aria-labelledby="tab01">
											...
											<h5>Biography:</h5>
											<p>
												Boudin leberkas jowl t-bone beef filet mignon. Beef hamburger rump drumstick, ham hock doner kielbasa salami short ribs tri-tip pork belly flank pancetta ribs turkey pork. Hamburger prosciutto beef rump alcatra pork strip steak.
												Pork belly short loin turkey ball tip flank salami meatball leberkas bacon bresaola salami meatloaf picanha doner kielbasa.
											</p>
										...
										<div class="tab-pane fade" id="tab02_pane" role="tabpanel" aria-labelledby="tab02">
											...
											<span class="small-text">Consulting</span>
											<div class="progress">
											...
											<span class="small-text">Finance</span>
											<div class="progress">
												<div class="progress-bar bg-maincolor2" role="progressbar" data-transitiongoal="98" aria-valuemin="0" aria-valuemax="100">
													<span>98%</span>
												</div>
											</div>

											<span class="small-text">Marketing</span>
											<div class="progress">
												<div class="progress-bar bg-maincolor3" role="progressbar" data-transitiongoal="93" aria-valuemin="0" aria-valuemax="100">
													<span>93%</span>
												</div>
											</div>
										...
										<div class="tab-pane fade" id="tab03_pane" role="tabpanel" aria-labelledby="tab03">
											...
											<form class="contact-form form-inverse" method="post" action="http://webdesign-finder.com/">
									...
									<blockquote class="vertical-item text-left">
