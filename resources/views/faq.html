...
<!-- Mirrored from webdesign-finder.com/html/okorner/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:41:43 GMT -->
<head>
						...
						<div class="col-lg-6">
							<div id="accordion02" role="tablist">
									...
									<div class="card-header" role="tab" id="collapse06_header">
										<h5>
											<a class="collapsed" data-toggle="collapse" href="#collapse06" aria-expanded="false" aria-controls="collapse06">
												<i class="fa fa-pencil"></i>
												How much time need to learn to learn karate?
											</a>
										</h5>
									</div>
									...
									<div class="card-header" role="tab" id="collapse09_header">
										<h5>
											<a class="collapsed" data-toggle="collapse" href="#collapse09" aria-expanded="false" aria-controls="collapse09">
												<i class="fa fa-pencil"></i>
												How many times a week does the lesson take place?
											</a>
										</h5>
									</div>
								...
								<div class="card">
									...
									<div id="collapse11" class="collapse" role="tabpanel" aria-labelledby="collapse10_header" data-parent="#accordion02">
										<div class="card-body">
											Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable sunt aliqua put a bird on it squid single-origin coffee shoreditch et.
										</div>
									</div>
									...
									<div class="card-header" role="tab" id="collapse12_header">
										<h5>
											<a class="collapsed" data-toggle="collapse" href="#collapse12" aria-expanded="false" aria-controls="collapse12">
												<i class="fa fa-pencil"></i>
												What are you doing in the section?
											</a>
										</h5>
									</div>
