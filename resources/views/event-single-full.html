...
<!-- Mirrored from webdesign-finder.com/html/okorner/event-single-full.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:41:37 GMT -->
<head>
...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-12 text-center">
							<h1 class="bold">Single Event without Sidebar</h1>
							<ol class="breadcrumb">
			...
			<section class="ds s-pt-60 s-pb-60 s-py-md-90 c-gutter-60">
				<div class="container">
					<div class="row">
