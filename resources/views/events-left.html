...
<!-- Mirrored from webdesign-finder.com/html/okorner/events-left.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:41:02 GMT -->
<head>
...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-12 text-center">
							<h1 class="bold">Events - Left Sidebar</h1>
							<ol class="breadcrumb">
			...
			<section class="ds s-pt-60 s-pb-0 s-py-md-90">
				<div class="container">
								...
								<div class="row">
									...
									<div class="col-xl-8 col-lg-7 col-md-6">
										<div class="item-content">
											...
											<h5>
												<a href="event-single-left.html">Magna aliquyam erased voluptua</a>
											</h5>

											<p class="item-meta color-darkgrey">
												<i class="fa fa-calendar color-main"></i> <span>March 12, 2018</span>
												<i class="fa fa-map-marker color-main"></i> <span>Consetetur sadipscing elitr</span>
											</p>
											<p>
												Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam et dolore magna aliquyam erat.
											</p>
										...
										<div class="item-content">
											...
											<h5>
												<a href="event-single-left.html">
													Cupiditate ducimus ea eaque error et excepturi
												</a>
											</h5>

											<p class="item-meta color-darkgrey">
												<i class="fa fa-calendar color-main"></i> <span>March 11, 2018</span>
												<i class="fa fa-map-marker color-main"></i> <span>Molestiae numquam officia</span>
											</p>
											<p>
								...
								<div class="row">
									...
									<div class="col-xl-8 col-lg-7 col-md-6">
										<div class="item-content">
											...
											<h5>
												<a href="event-single-left.html">Aliquam amet atque deleniti dignissimos dolor</a>
											</h5>

											<p class="item-meta color-darkgrey">
												<i class="fa fa-calendar color-main"></i> <span>March 9, 2018</span>
												<i class="fa fa-map-marker color-main"></i> <span>Optio quam quod saepe</span>
											</p>
											<p>
												Aliquam amet, atque deleniti dignissimos dolor ducimus eaque eos error et facere ipsam iste laboriosam molestias optio quam quod saepe tempore voluptates.
											</p>
								...
								<div class="row">
									...
									<div class="col-xl-8 col-lg-7 col-md-6">
										<div class="item-content">
											...
											<h5>
												<a href="event-single-left.html">
													Ad ipsam itaque molestias quasi ratione
												</a>
											</h5>

											<p class="item-meta color-darkgrey">
												<i class="fa fa-calendar color-main"></i> <span>March 4, 2018</span>
												<i class="fa fa-map-marker color-main"></i> <span>Quasi ratione saepe sequi</span>
											</p>
											<p>
												Accusantium, asperiores culpa iusto molestias reiciendis repellat voluptatum? Ad ipsam itaque molestias quasi ratione. Amet dolor laborum libero, quasi ratione saepe sequi.
											</p>
								...
								<div class="row">
									...
									<div class="col-xl-8 col-lg-7 col-md-6">
										<div class="item-content">
											...
											<p class="item-meta color-darkgrey">
												<i class="fa fa-calendar color-main"></i> <span>March 2, 2018</span>
												<i class="fa fa-map-marker color-main"></i> <span>Consetetur sadipscing elitr</span>
											</p>
											<p>
												Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam et dolore magna aliquyam erat.
								...
								<div class="row">
									...
									<div class="col-xl-8 col-lg-7 col-md-6">
										<div class="item-content">
											...
											<p class="item-meta color-darkgrey">
												<i class="fa fa-calendar color-main"></i> <span>Jan 30, 2018</span>
												<i class="fa fa-map-marker color-main"></i> <span>Magni modi molestiae numquam</span>
											</p>
											<p>
												Cupiditate ducimus ea eaque error et excepturi ipsa ipsam, magni modi molestiae numquam officia quo quos ratione sed, similique ut voluptate.
											</p>
								...
								<div class="row">
									...
									<div class="col-xl-8 col-lg-7 col-md-6">
										<div class="item-content">
											...
											<p class="item-meta color-darkgrey">
												<i class="fa fa-calendar color-main"></i> <span>Jan 26, 2018</span>
												<i class="fa fa-map-marker color-main"></i> <span>Quod saepe tempore voluptates</span>
											</p>
											<p>
												Aliquam amet, atque deleniti dignissimos dolor ducimus eaque eos error et facere ipsam iste laboriosam molestias optio quam quod saepe tempore voluptates.
											</p>
								...
								<div class="row">
									...
									<div class="col-xl-8 col-lg-7 col-md-6">
										<div class="item-content">
											...
											<p class="item-meta color-darkgrey">
												<i class="fa fa-calendar color-main"></i> <span>Jan 20, 2018</span>
												<i class="fa fa-map-marker color-main"></i> <span>Itaque molestias quasi ratione</span>
											</p>
											<p>
												Accusantium, asperiores culpa iusto molestias reiciendis repellat voluptatum? Ad ipsam itaque molestias quasi ratione. Amet dolor laborum libero, quasi ratione saepe sequi.
											</p>
								...
								<div class="row">
									...
									<div class="col-xl-8 col-lg-7 col-md-6">
										<div class="item-content">
											...
											<p class="item-meta color-darkgrey">
												<i class="fa fa-calendar color-main"></i> <span>March 16, 2018</span>
												<i class="fa fa-map-marker color-main"></i> <span>Consetetur sadipscing elitr</span>
											</p>
											<p>
												Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam et dolore magna aliquyam erat.
								...
								<div class="row">
									...
									<div class="col-xl-8 col-lg-7 col-md-6">
										<div class="item-content">
											...
											<p class="item-meta color-darkgrey">
												<i class="fa fa-calendar color-main"></i> <span>Jan 10, 2018</span>
												<i class="fa fa-map-marker color-main"></i> <span>Magni modi molestiae</span>
											</p>
											<p>
												Cupiditate ducimus ea eaque error et excepturi ipsa ipsam, magni modi molestiae numquam officia quo quos ratione sed, similique ut voluptate.
											</p>
						...
						<aside class="col-lg-5 col-xl-4 order-lg-1">
									...
									<div class="apsc-each-profile">
										<a class="apsc-facebook-icon clearfix" href="#">
											<div class="apsc-inner-block">
												...
												<span class="apsc-count">10,548</span><span class="apsc-media-type">likes</span>
											</div>
										</a>
									</div>
									<div class="apsc-each-profile">
									...
									<div class="apsc-each-profile">
										<a class="apsc-google-plus-icon clearfix" href="#">
											<div class="apsc-inner-block">
												...
												<span class="apsc-count">743</span><span class="apsc-media-type">Fans</span>
											</div>
										</a>
									</div>
								</div>
							...
							<div class="widget widget_mailchimp">
								...
								<form class="signup" action="http://webdesign-finder.com/">
									...
									<input id="mailchimp_email1" name="email" type="email" class="mailchimp_email" placeholder="Enter Your Email">
								...
								<ul class="list-unstyled">
									<li class="media">
										...
										<div class="media-body">
											<h4>
												<a href="blog-single-right.html">Shoulder meatloaf brisket short ribs ball tip</a>
											</h4>
											<p class="item-meta">
												Dec 18, 2018
											</p>
									...
									<li class="media">
										...
										<div class="media-body">
											<h4>
												<a href="blog-single-right.html">Strip steak ground round jerky
													picanha turkey pork </a>
											</h4>
											<p class="item-meta">
												Nov 22, 2018
											</p>
									...
									<li class="media">
										...
										<div class="media-body">
											<h4>
												<a href="blog-single-right.html">Pork belly boudin ball tip shankle burgdoggen</a>
											</h4>
											<p class="item-meta">
												Nov 12, 2018
											</p>
					...
					<div class="row align-items-start justify-content-center">
						...
						<div class="col-md-6 col-lg-4 text-center animate" data-animation="fadeInUp">
							...
							<div class="widget widget_recent_entries">
								...
								<ul>
									<li>
										<a href="blog-single-right.html">How I Lost The Secret Of My Dazzling Success For 20 Years</a>
										<span class="post-date">26 dec 2017</span>
									</li>
									<li>
										<a href="blog-single-right.html">Make It Your Destiny To Accomplish Great Things In Your Life</a>
						...
						<div class="col-md-6 col-lg-4 text-center animate" data-animation="fadeInUp">
							<div class="widget widget_icons_list">
								...
								<div class="widget widget_social_buttons">
									...
									<a href="https://twitter.com/" class="fa fa-twitter border-icon rounded-icon" title="twitter"></a>
									<a href="https://www.google.com/" class="fa fa-google-plus border-icon rounded-icon" title="google"></a>
								</div>
							</div>
						</div>
...
<!-- Mirrored from webdesign-finder.com/html/okorner/events-left.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 May 2020 14:41:37 GMT -->
</html>